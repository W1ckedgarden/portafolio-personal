...
function ContentSections({ onAddToInterests }) {  // Recibe una función para agregar secciones a los intereses
  return (
    <section className="contenido">  {/* Sección que contiene todas las subsecciones */}
      <article className="sobre-mi" id="sobre-mi">  {/* Sección sobre mí */}
      ...
      <article className="estudios" id="estudios">  {/* Sección de estudios */}
      ...
      <article className="ultimo-trabajo" id="ultimo-trabajo">  {/* Sección del último trabajo */}
      ...
      <article className="ubicacion" id="ubicacion">  {/* Sección de ubicación */}
